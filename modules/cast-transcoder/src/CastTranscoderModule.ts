...
declare class CastTranscoderModule extends NativeModule<CastTranscoderEvents> {
   ...
   * Resolves with outputPath; rejects (ERR_CANCELLED / ERR_TRANSCODE) otherwise.
   */
  transcode(inputUri: string, outputPath: string, maxHeight: number, maxWidth: number): Promise<string>;
